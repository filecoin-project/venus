...
func newHCEvents(api IEvent, obs *observer) *hcEvents {
	e := &hcEvents{
		cs:          api,
		confQueue:   map[triggerH]map[msgH][]*queuedEvent{},
		revertQueue: map[msgH][]triggerH{},
...
func newWatcherEvents(hcAPI headChangeAPI, cs IEvent) watcherEvents {
...
func newMessageEvents(hcAPI headChangeAPI, cs IEvent) messageEvents {
