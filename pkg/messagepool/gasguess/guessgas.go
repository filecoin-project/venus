...
type ActorLookup func(context.Context, address.Address, block.TipSetKey) (*types.Actor, error)
...
func GuessGasUsed(ctx context.Context, tsk block.TipSetKey, msg *types.SignedMessage, al ActorLookup) (int64, error) {
