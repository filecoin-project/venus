...
// BeaconForEpoch selects beacon at specified epoch
...
// DrandConfigSchedule creates new beacon schedule, used to select beacon server at specified chain height
