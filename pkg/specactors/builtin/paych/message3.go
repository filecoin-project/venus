...
func (m message3) Create(to address.Address, initialAmount abi.TokenAmount) (*types.UnsignedMessage, error) {
...
func (m message3) Update(paych address.Address, sv *SignedVoucher, secret []byte) (*types.UnsignedMessage, error) {
...
func (m message3) Settle(paych address.Address) (*types.UnsignedMessage, error) {
	return &types.UnsignedMessage{
		To:     paych,
		From:   m.from,
		Value:  abi.NewTokenAmount(0),
...
func (m message3) Collect(paych address.Address) (*types.UnsignedMessage, error) {
	return &types.UnsignedMessage{
		To:     paych,
		From:   m.from,
		Value:  abi.NewTokenAmount(0),
