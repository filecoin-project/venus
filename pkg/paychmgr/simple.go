...
func newFundsReq(ctx context.Context, amt big.Int, opts GetOpts) *fundsReq {
...
func (m *mergedFundsReq) sum() (big.Int, big.Int) {
	sum := big.NewInt(0)
...
// be attempted.
func (ca *channelAccessor) getPaych(ctx context.Context, amt big.Int, opts GetOpts) (address.Address, cid.Cid, error) {
...
func (ca *channelAccessor) processQueue(ctx context.Context, channelID string) (*types.ChannelAvailableFunds, error) {
	...
	if len(ca.fundsReqQueue) == 0 {
		return ca.currentAvailableFunds(ctx, channelID, big.NewInt(0))
	}
...
func (ca *channelAccessor) createPaych(ctx context.Context, amt, avail big.Int) (cid.Cid, error) {
