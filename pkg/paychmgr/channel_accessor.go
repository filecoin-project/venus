...
func (ca *channelAccessor) messageBuilder(ctx context.Context, from address.Address) (paych.MessageBuilder, error) {
	...
	return paych.Message(specactors.VersionForNetwork(nwVersion), from), nil
}
...
func (ca *channelAccessor) createVoucher(ctx context.Context, ch address.Address, voucher paych.SignedVoucher) (*api.VoucherCreateResult, error) {
	...
	return &api.VoucherCreateResult{Voucher: sv, Shortfall: big.NewInt(0)}, nil
}
...
func (ca *channelAccessor) addVoucher(ctx context.Context, ch address.Address, sv *paych.SignedVoucher, minDelta big.Int) (big.Int, error) {
	ca.lk.Lock()
	defer ca.lk.Unlock()
