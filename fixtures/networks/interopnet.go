...
func InteropNet() *NetworkConf {
	return &NetworkConf{
		Bootstrap: config.BootstrapConfig{
			Addresses: []string{
				"/dns4/bootstrap-0.interop.fildev.network/tcp/1347/p2p/12D3KooWMaiZgqoRbHZkTU2tnc8HuAy8Jvb6cvLdj39fC8bqpjSn",
				"/dns4/bootstrap-1.interop.fildev.network/tcp/1347/p2p/12D3KooWGMCXwzx25bt2y8gCS1SdzZGeM6swb68EbZC3g3fnJRhc",
			},
			MinPeerThreshold: 0,
			Period:           "30s",
		},
