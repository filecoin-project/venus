...
func InteropNet() *NetworkConf {
	return &NetworkConf{
		Bootstrap: config.BootstrapConfig{
			Addresses: []string{
				"/dns4/bootstrap-0.interop.fildev.network/tcp/1347/p2p/12D3KooWAvoLA7sFgc8PwCpquDYFrcKss7FPR8W8sjntPZbMfWJM",
				"/dns4/bootstrap-1.interop.fildev.network/tcp/1347/p2p/12D3KooWNMSg7nHhT4YZyGqv47y67ZcG9VVrSLuCrpgFcT5JYcMb",
			},
			MinPeerThreshold: 0,
			Period:           "30s",
		},
