...
type Protocol interface {
	...
	RunStateTransition(ctx context.Context, ts types.TipSet, blsMsgs [][]*types.MeteredMessage, secpMsgs [][]*types.SignedMessage, tsReceipts [][]*types.MessageReceipt, ancestors []types.TipSet, parentWeight uint64, stateID cid.Cid) (cid.Cid, error)
