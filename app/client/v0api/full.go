...
type IChainInfoStruct struct {
	Internal struct {
		...
		ChainGetMessagesInTipset      func(p0 context.Context, p1 types.TipSetKey) ([]types.Message, error)                                                              `perm:"read"`
		ChainGetParentMessages        func(p0 context.Context, p1 cid.Cid) ([]types.Message, error)                                                                      `perm:"read"`
...
func (s *IChainInfoStruct) ChainGetMessagesInTipset(p0 context.Context, p1 types.TipSetKey) ([]types.Message, error) {
	return s.Internal.ChainGetMessagesInTipset(p0, p1)
}

func (s *IChainInfoStruct) ChainGetParentMessages(p0 context.Context, p1 cid.Cid) ([]types.Message, error) {
