...
func (ep *TestElectionPoster) ComputeElectionPoSt(ctx context.Context, minerID abi.ActorID, sectorInfo []abi.SectorInfo, challengeSeed abi.PoStRandomness, winners []abi.PoStCandidate) ([]abi.PoStProof, error) {
...
func (ep *TestElectionPoster) GenerateEPostCandidates(ctx context.Context, minerID abi.ActorID, sectorInfos []abi.SectorInfo, challengeSeed abi.PoStRandomness, faults []abi.SectorNumber) ([]storage.PoStCandidateWithTicket, error) {
	...
	var candidatesWithTickets []storage.PoStCandidateWithTicket
	...
	for i, si := range sectorInfos {
		...
		nextCandidateWithTicket := storage.PoStCandidateWithTicket{
