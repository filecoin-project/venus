...
func TestMessagePropagation(t *testing.T) {
	...
	builder1.WithBuilderOpt(MonkeyPatchProofTypeOption(constants.DevRegisteredSealProof))
	...
	builder2.WithBuilderOpt(MonkeyPatchProofTypeOption(constants.DevRegisteredSealProof))
	receiverCount := 2
