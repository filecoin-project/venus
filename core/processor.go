...
type Processor func(ctx context.Context, blk *types.Block, st types.StateTreeInterface) error
...
func ProcessBlock(ctx context.Context, blk *types.Block, st types.StateTreeInterface) error {
...
func ApplyMessage(ctx context.Context, st types.StateTreeInterface, msg *types.Message) error {
	if msg.From() == msg.To() {
		// TODO: handle this
