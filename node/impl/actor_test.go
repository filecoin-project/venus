...
func TestActorLs(t *testing.T) {
	...
	validateActorView := func(a *iface.ActorView, sl gojsonschema.JSONLoader) (*gojsonschema.Result, error) {
	...
	assertSchemaValid := func(t *testing.T, a *iface.ActorView, sl gojsonschema.JSONLoader) {
		assert := assert.New(t)
		require := require.New(t)
