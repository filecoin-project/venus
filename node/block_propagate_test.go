...
func makeNodes(t *testing.T, numNodes int) (address.Address, []*Node) {
	...
	_, err := storage.NewMiner(mineraddr, ownerAddr, ownerAddr, &storage.FakeProver{}, types.OneKiBSectorSize, minerNode, minerNode.Repo.DealsDatastore(), minerNode.PorcelainAPI, &TrivialSlasher{})
