...
func requiredCommonDeps(t *testing.T, gif chain.GenesisInitFunc) *commonDeps { // nolint: deadcode
...
// block store).
func requireCommonDepsWithGifAndBlockstore(t *testing.T, gif chain.GenesisInitFunc, r repo.Repo, bs bstore.Blockstore) *commonDeps {
