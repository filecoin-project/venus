...
var provingInfoCmd = &cmds.Command{
	...
	Run: func(req *cmds.Request, re cmds.ResponseEmitter, env cmds.Environment) error {
		...
		stor := adt.WrapStore(ctx, cbor.NewCborStore(blockstoreutil.NewAPIBlockstore(env.(*node.Env).BlockStoreAPI)))
...
var provingFaultsCmd = &cmds.Command{
	...
	Run: func(req *cmds.Request, re cmds.ResponseEmitter, env cmds.Environment) error {
		...
		stor := adt.WrapStore(ctx, cbor.NewCborStore(blockstoreutil.NewAPIBlockstore(bstoreAPI)))
