...
func TestHelloHandshake(t *testing.T) {
	...
	discovery.NewHandler(a, genesisA.Cid(), msc1.HelloCallback, hg1.getHeaviestTipSet, "").Register()
	discovery.NewHandler(b, genesisA.Cid(), msc2.HelloCallback, hg2.getHeaviestTipSet, "").Register()
...
func TestHelloBadGenesis(t *testing.T) {
	...
	discovery.NewHandler(a, genesisA.Cid(), msc1.HelloCallback, hg1.getHeaviestTipSet, "").Register()
	discovery.NewHandler(b, genesisB.Cid(), msc2.HelloCallback, hg2.getHeaviestTipSet, "").Register()
...
func TestHelloMultiBlock(t *testing.T) {
	...
	discovery.NewHandler(a, genesisTipset.At(0).Cid(), msc1.HelloCallback, hg1.getHeaviestTipSet, "").Register()
	discovery.NewHandler(b, genesisTipset.At(0).Cid(), msc2.HelloCallback, hg2.getHeaviestTipSet, "").Register()
