...
var lengthBufGreetingMessage = []byte{132}
...
func (t *GreetingMessage) MarshalCBOR(w io.Writer) error {
	...
	if _, err := cw.Write(lengthBufGreetingMessage); err != nil {
		return err
	}
	...
	*t = GreetingMessage{}
...

	{
		...
		if err := t.HeaviestTipSetWeight.UnmarshalCBOR(cr); err != nil {
			return xerrors.Errorf("unmarshalling t.HeaviestTipSetWeight: %w", err)
		}
