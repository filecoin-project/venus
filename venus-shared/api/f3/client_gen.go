...
const APINamespace = "f3.F3"
const MethodNamespace = "F3"

// NewF3RPC creates a new httpparse jsonrpc remotecli.
func NewF3RPC(ctx context.Context, addr string, requestHeader http.Header, opts ...jsonrpc.Option) (F3, jsonrpc.ClientCloser, error) {
...
// DialF3RPC is a more convinient way of building client, as it resolves any format (url, multiaddr) of addr string.
func DialF3RPC(ctx context.Context, addr string, token string, requestHeader http.Header, opts ...jsonrpc.Option) (F3, jsonrpc.ClientCloser, error) {
