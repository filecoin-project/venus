...
// Source: github.com/filecoin-project/venus/venus-shared/api/gateway/v2 (interfaces: IGateway)
...
func (mr *MockIGatewayMockRecorder) RegisterReverse(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RegisterReverse", reflect.TypeOf((*MockIGateway)(nil).RegisterReverse), arg0, arg1, arg2)
}
