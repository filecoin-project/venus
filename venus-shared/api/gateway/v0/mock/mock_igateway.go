...
// Source: github.com/filecoin-project/venus/venus-shared/api/gateway/v0 (interfaces: IGateway)
...
func (m *MockIGateway) ComputeProof(arg0 context.Context, arg1 address.Address, arg2 []proof.SectorInfo, arg3 abi.PoStRandomness) ([]proof.PoStProof, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ComputeProof", arg0, arg1, arg2, arg3)
...
func (mr *MockIGatewayMockRecorder) ComputeProof(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ComputeProof", reflect.TypeOf((*MockIGateway)(nil).ComputeProof), arg0, arg1, arg2, arg3)
}
