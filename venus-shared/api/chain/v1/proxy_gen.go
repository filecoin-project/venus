...
type IMultiSigStruct struct {
	Internal struct {
		...
		MsigApproveTxnHash func(p0 context.Context, p1 address.Address, p2 uint64, p3 address.Address, p4 address.Address, p5 types.BigInt, p6 address.Address, p7 uint64, p8 []byte) (*types.MessagePrototype, error) `perm:"sign"`
		...
		MsigCancelTxnHash func(p0 context.Context, p1 address.Address, p2 uint64, p3 address.Address, p4 types.BigInt, p5 address.Address, p6 uint64, p7 []byte) (*types.MessagePrototype, error) `perm:"sign"`
...
type IPaychanStruct struct {
	Internal struct {
		...
		PaychVoucherAdd func(p0 context.Context, p1 address.Address, p2 *types.SignedVoucher, p3 []byte, p4 big.Int) (big.Int, error) `perm:"write"`

		PaychVoucherCheckSpendable func(p0 context.Context, p1 address.Address, p2 *types.SignedVoucher, p3 []byte, p4 []byte) (bool, error) `perm:"read"`

		PaychVoucherCheckValid func(p0 context.Context, p1 address.Address, p2 *types.SignedVoucher) error `perm:"read"`
		...
		PaychVoucherList func(p0 context.Context, p1 address.Address) ([]*types.SignedVoucher, error) `perm:"write"`

		PaychVoucherSubmit func(p0 context.Context, p1 address.Address, p2 *types.SignedVoucher, p3 []byte, p4 []byte) (cid.Cid, error) `perm:"sign"`
	}
}
...
type ISyncerStruct struct {
	Internal struct {
		...
		SyncerTracker func(p0 context.Context) *types.TargetTracker `perm:"read"`
	}
}
...
type IWalletStruct struct {
	Internal struct {
		...
		WalletExport func(p0 context.Context, p1 address.Address, p2 string) (*types.KeyInfo, error) `perm:"admin"`
