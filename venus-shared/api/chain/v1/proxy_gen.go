...
type IETHStruct struct {
	Internal struct {
		...
		EthEstimateGas                         func(ctx context.Context, tx types.EthCall) (types.EthInt, error)                                           `perm:"read"`
...
func (s *IETHStruct) EthEstimateGas(p0 context.Context, p1 types.EthCall) (types.EthInt, error) {
