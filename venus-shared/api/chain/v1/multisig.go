...
type IMultiSig interface {
	...
	MsigCancelTxnHash(context.Context, address.Address, uint64, address.Address, chain.BigInt, address.Address, uint64, []byte) (*messagepool.MessagePrototype, error)                                                                   //perm:sign
	...
	MsigCancel(ctx context.Context, msig address.Address, txID uint64, src address.Address) (*messagepool.MessagePrototype, error)                                                                                                       //perm:sign
