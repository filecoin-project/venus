...
import (
	...
	miner1 "github.com/filecoin-project/venus/venus-shared/actors/builtin/miner"
...
func (m *MockFullNode) EthGetBlockReceipts(arg0 context.Context, arg1 types.EthBlockNumberOrHash) ([]*types.EthTxReceipt, error) {
	m.ctrl.T.Helper()
...
func (m *MockFullNode) EthGetBlockReceiptsLimited(arg0 context.Context, arg1 types.EthBlockNumberOrHash, arg2 abi.ChainEpoch) ([]*types.EthTxReceipt, error) {
	m.ctrl.T.Helper()
...
func (m *MockFullNode) EthTraceFilter(arg0 context.Context, arg1 types.EthTraceFilterCriteria) ([]*types.EthTraceFilterResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EthTraceFilter", arg0, arg1)
	ret0, _ := ret[0].([]*types.EthTraceFilterResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockFullNode) EthTraceTransaction(arg0 context.Context, arg1 string) ([]*types.EthTraceTransaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EthTraceTransaction", arg0, arg1)
	ret0, _ := ret[0].([]*types.EthTraceTransaction)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockFullNode) F3GetECPowerTable(arg0 context.Context, arg1 types0.TipSetKey) (gpbft.PowerEntries, error) {
	m.ctrl.T.Helper()
...
func (m *MockFullNode) F3GetF3PowerTable(arg0 context.Context, arg1 types0.TipSetKey) (gpbft.PowerEntries, error) {
	m.ctrl.T.Helper()
...
func (m *MockFullNode) GetActorEventsRaw(arg0 context.Context, arg1 *types0.ActorEventFilter) ([]*types0.ActorEvent, error) {
	...
	ret0, _ := ret[0].([]*types0.ActorEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockFullNode) StateMarketProposalPending(arg0 context.Context, arg1 cid.Cid, arg2 types0.TipSetKey) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockFullNode) StateMinerCreationDeposit(arg0 context.Context, arg1 types0.TipSetKey) (big.Int, error) {
	m.ctrl.T.Helper()
...
func (m *MockFullNode) StateMinerInitialPledgeCollateral(arg0 context.Context, arg1 address.Address, arg2 miner0.SectorPreCommitInfo, arg3 types0.TipSetKey) (big.Int, error) {
	m.ctrl.T.Helper()
...
func (m *MockFullNode) StateMinerPreCommitDepositForPower(arg0 context.Context, arg1 address.Address, arg2 miner0.SectorPreCommitInfo, arg3 types0.TipSetKey) (big.Int, error) {
	m.ctrl.T.Helper()
...
func (m *MockFullNode) StateSectorExpiration(arg0 context.Context, arg1 address.Address, arg2 abi.SectorNumber, arg3 types0.TipSetKey) (*miner1.SectorExpiration, error) {
	m.ctrl.T.Helper()
...
func (m *MockFullNode) StateSectorPartition(arg0 context.Context, arg1 address.Address, arg2 abi.SectorNumber, arg3 types0.TipSetKey) (*miner1.SectorLocation, error) {
	m.ctrl.T.Helper()
...
func (m *MockFullNode) StateSectorPreCommitInfo(arg0 context.Context, arg1 address.Address, arg2 abi.SectorNumber, arg3 types0.TipSetKey) (*miner0.SectorPreCommitOnChainInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockFullNode) SubscribeActorEventsRaw(arg0 context.Context, arg1 *types0.ActorEventFilter) (<-chan *types0.ActorEvent, error) {
	...
	ret0, _ := ret[0].(<-chan *types0.ActorEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
