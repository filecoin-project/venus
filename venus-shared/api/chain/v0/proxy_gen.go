...
type IChainInfoStruct struct {
	Internal struct {
		...
		StateGetReceipt func(p0 context.Context, p1 cid.Cid, p2 chain.TipSetKey) (*chain.MessageReceipt, error) `perm:"read"`
		...
		StateSearchMsg func(p0 context.Context, p1 cid.Cid) (*chain2.MsgLookup, error) `perm:"read"`

		StateSearchMsgLimited func(p0 context.Context, p1 cid.Cid, p2 abi.ChainEpoch) (*chain2.MsgLookup, error) `perm:"read"`
		...
		StateWaitMsg func(p0 context.Context, p1 cid.Cid, p2 uint64) (*chain2.MsgLookup, error) `perm:"read"`

		StateWaitMsgLimited func(p0 context.Context, p1 cid.Cid, p2 uint64, p3 abi.ChainEpoch) (*chain2.MsgLookup, error) `perm:"read"`
...
func (s *IChainInfoStruct) StateGetReceipt(p0 context.Context, p1 cid.Cid, p2 chain.TipSetKey) (*chain.MessageReceipt, error) {
...
func (s *IChainInfoStruct) StateSearchMsg(p0 context.Context, p1 cid.Cid) (*chain2.MsgLookup, error) {
	return s.Internal.StateSearchMsg(p0, p1)
}

func (s *IChainInfoStruct) StateSearchMsgLimited(p0 context.Context, p1 cid.Cid, p2 abi.ChainEpoch) (*chain2.MsgLookup, error) {
...
func (s *IChainInfoStruct) StateWaitMsg(p0 context.Context, p1 cid.Cid, p2 uint64) (*chain2.MsgLookup, error) {
	return s.Internal.StateWaitMsg(p0, p1, p2)
}

func (s *IChainInfoStruct) StateWaitMsgLimited(p0 context.Context, p1 cid.Cid, p2 uint64, p3 abi.ChainEpoch) (*chain2.MsgLookup, error) {
...
type IMessagePoolStruct struct {
	Internal struct {
		...
		MpoolPublishMessage func(p0 context.Context, p1 *chain.SignedMessage) error `perm:"admin"`
...
type IMultiSigStruct struct {
	Internal struct {
		...
		MsigApproveTxnHash func(p0 context.Context, p1 address.Address, p2 uint64, p3 address.Address, p4 address.Address, p5 chain.BigInt, p6 address.Address, p7 uint64, p8 []byte) (cid.Cid, error) `perm:"sign"`

		MsigCancel func(p0 context.Context, p1 address.Address, p2 uint64, p3 address.Address) (cid.Cid, error) `perm:"sign"`

		MsigCancelTxnHash func(p0 context.Context, p1 address.Address, p2 uint64, p3 address.Address, p4 chain.BigInt, p5 address.Address, p6 uint64, p7 []byte) (cid.Cid, error) `perm:"sign"`

		MsigCreate func(p0 context.Context, p1 uint64, p2 []address.Address, p3 abi.ChainEpoch, p4 chain.BigInt, p5 address.Address, p6 chain.BigInt) (cid.Cid, error) `perm:"sign"`
		...
		MsigPropose func(p0 context.Context, p1 address.Address, p2 address.Address, p3 chain.BigInt, p4 address.Address, p5 uint64, p6 []byte) (cid.Cid, error) `perm:"sign"`
...
func (s *IMultiSigStruct) MsigApproveTxnHash(p0 context.Context, p1 address.Address, p2 uint64, p3 address.Address, p4 address.Address, p5 chain.BigInt, p6 address.Address, p7 uint64, p8 []byte) (cid.Cid, error) {
...
func (s *IMultiSigStruct) MsigCancelTxnHash(p0 context.Context, p1 address.Address, p2 uint64, p3 address.Address, p4 chain.BigInt, p5 address.Address, p6 uint64, p7 []byte) (cid.Cid, error) {
	return s.Internal.MsigCancelTxnHash(p0, p1, p2, p3, p4, p5, p6, p7)
}

func (s *IMultiSigStruct) MsigCreate(p0 context.Context, p1 uint64, p2 []address.Address, p3 abi.ChainEpoch, p4 chain.BigInt, p5 address.Address, p6 chain.BigInt) (cid.Cid, error) {
...
func (s *IMultiSigStruct) MsigPropose(p0 context.Context, p1 address.Address, p2 address.Address, p3 chain.BigInt, p4 address.Address, p5 uint64, p6 []byte) (cid.Cid, error) {
