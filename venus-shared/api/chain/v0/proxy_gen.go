...
type IMultiSigStruct struct {
	Internal struct {
		...
		MsigCancel func(p0 context.Context, p1 address.Address, p2 uint64, p3 address.Address, p4 chain.BigInt, p5 address.Address, p6 uint64, p7 []byte) (cid.Cid, error) `perm:"sign"`
...
func (s *IMultiSigStruct) MsigCancel(p0 context.Context, p1 address.Address, p2 uint64, p3 address.Address, p4 chain.BigInt, p5 address.Address, p6 uint64, p7 []byte) (cid.Cid, error) {
