...
func loadMethodsMap() {
	...
	actors = append(actors, actorsWithVersion{av: actorstypes.Version12, actors: builtin.MakeRegistry(actorstypes.Version12)})
	actors = append(actors, actorsWithVersion{av: actorstypes.Version13, actors: builtin.MakeRegistry(actorstypes.Version13)})
	actors = append(actors, actorsWithVersion{av: actorstypes.Version14, actors: builtin.MakeRegistry(actorstypes.Version14)})
	actors = append(actors, actorsWithVersion{av: actorstypes.Version15, actors: builtin.MakeRegistry(actorstypes.Version15)})
	actors = append(actors, actorsWithVersion{av: actorstypes.Version16, actors: builtin.MakeRegistry(actorstypes.Version16)})
	actors = append(actors, actorsWithVersion{av: actorstypes.Version17, actors: builtin.MakeRegistry(actorstypes.Version17)})
	actors = append(actors, actorsWithVersion{av: actorstypes.Version18, actors: builtin.MakeRegistry(actorstypes.Version18)})
	actors = append(actors, actorsWithVersion{av: actorstypes.Version19, actors: builtin.MakeRegistry(actorstypes.Version19)})
