...
type message18 struct{ message0 }

func (m message18) Create(
	...
	msigParams := &multisig18.ConstructorParams{
		Signers:               signers,
	...
	code, ok := actors.GetActorCodeID(actorstypes.Version18, manifest.MultisigKey)
	if !ok {
