...
type message16 struct{ message0 }

func (m message16) Create(
	...
	msigParams := &multisig16.ConstructorParams{
		Signers:               signers,
	...
	code, ok := actors.GetActorCodeID(actorstypes.Version16, manifest.MultisigKey)
	if !ok {
