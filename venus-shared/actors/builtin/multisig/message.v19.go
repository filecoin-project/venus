...
type message19 struct{ message0 }

func (m message19) Create(
	...
	msigParams := &multisig19.ConstructorParams{
		Signers:               signers,
	...
	code, ok := actors.GetActorCodeID(actorstypes.Version19, manifest.MultisigKey)
	if !ok {
