...
func (s *state4) RampStartEpoch() int64 {
	return 0
}

func (s *state4) RampDurationEpochs() uint64 {
	return 0
}
...
func (s *state4) CollectEligibleClaims(cacheInOut *builtin17.MapReduceCache) ([]builtin17.OwnedClaim, error) {
