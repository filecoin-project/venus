...
func initEthLegacy155TxSignature() {
	EthLegacy155TxSignatureLen0 = calcEIP155TxSignatureLen(uint64(Eip155ChainID), 35)
	EthLegacy155TxSignatureLen1 = calcEIP155TxSignatureLen(uint64(Eip155ChainID), 36)
}
...
func getEthParamsAndRecipient(msg *Message) (params []byte, to *EthAddress, err error) {
	if len(msg.Params) > 0 {
