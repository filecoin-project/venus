...
require (
	...
	github.com/filecoin-project/chain-validation v0.0.6-0.20200324182143-402067d49f32
	...
	github.com/filecoin-project/go-fil-markets v0.0.0-20200320155651-9b85359e6e5d
